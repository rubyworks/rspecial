...
{Homepage}[http://rubyworks.github.com/rspeclature] /
{Source Code}[http://github.com/rubyworks/rspeclature] /
{Mailing List}[http://groups.google.com/group/rubyworks-mailinglist]


== DESCRIPTION

RSpeclature is an BRASS-compliant *assertions framework*. It defines
...
Simply require the `rspeclature` script, and include the `RSpeclature::Matchers`
